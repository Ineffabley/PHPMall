        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        <h3>电子商品</h3>
                        <a href="dizi.php" class="cta-btn">选购 <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        <h3>生活用品</h3>
                        <a href="shenghuo.php" class="cta-btn">选购 <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        <h3>学习用品</h3>
                        <a href="xuexi.php" class="cta-btn">选购 <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
